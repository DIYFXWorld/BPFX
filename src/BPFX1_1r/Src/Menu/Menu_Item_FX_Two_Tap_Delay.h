#ifndef Menu_Item_FX_Two_Tap_Delay_h_
#define Menu_Item_FX_Two_Tap_Delay_h_

#include "Myutil.h"
#include "Menu_Item_Interface.h"
#include "FX_Two_Tap_Delay.h"

struct Menu_Item_FX_Two_Tap_Delay : public Menu_Item_Interface
{
	int8_t	Time, Feedback, Mix_Level;

	Menu_Item_FX_Two_Tap_Delay():
