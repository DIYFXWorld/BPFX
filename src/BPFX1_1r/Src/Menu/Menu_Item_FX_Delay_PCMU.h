#ifndef Menu_Item_FX_Delay_PCMU_h_
#define Menu_Item_FX_Delay_PCMU_h_

#include "Myutil.h"
#include "Menu_Item_Interface.h"
#include "FX_Delay_PCMU.h"

struct Menu_Item_FX_Delay_PCMU : public Menu_Item_Interface
{
	int8_t	Time, Feedback, Mix_Level;

	Menu_Item_FX_Delay_PCMU():
