#ifndef Menu_Item_FX_String_Chorus_h_
#define Menu_Item_FX_String_Chorus_h_

#include "Myutil.h"
#include "Menu_Item_Interface.h"
#include "vcp_mini.h"
#include "FX_String_Chorus.h"

struct Menu_Item_FX_String_Chorus : public Menu_Item_Interface
{
