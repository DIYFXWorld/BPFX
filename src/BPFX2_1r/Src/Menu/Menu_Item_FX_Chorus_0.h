#ifndef Menu_Item_FX_Chorus_0_h_
#define Menu_Item_FX_Chorus_0_h_

#include "Myutil.h"
#include "Menu_Item_Interface.h"
#include "vcp_mini.h"
#include "FX_Chorus_0.h"

struct Menu_Item_FX_Chorus_0 : public Menu_Item_Interface
{
	int8_t	Rate, Depth, Mix_Level;

	Menu_Item_FX_Chorus_0():
